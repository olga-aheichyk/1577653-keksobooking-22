...
const createCardLayout = function(object) {
  ...
  cardArticle.querySelector('.popup__avatar').src = object.author.avatar;
  ...
  cardArticle.querySelector('.popup__type').textContent = object.offer.type;
  // переделать flat в квартира
